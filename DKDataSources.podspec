...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DKDataSources.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Denis Kakačka/DKDataSources'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Denis Kakačka' => 'dkakacka@sygic.com' }
  s.source           = { :git => 'https://github.com/Denis Kakačka/DKDataSources.git', :tag => s.version.to_s }
